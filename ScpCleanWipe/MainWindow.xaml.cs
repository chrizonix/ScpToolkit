    ...
    public partial class MainWindow : Window
    {
        ...
        private async void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            await Task.Run(() =>
            {
                ...
                foreach (var entry in storeEntries.Where(dse => dse.DriverPkgProvider.Equals("Scarlet.Crush Productions") || dse.DriverPkgProvider.Equals("Nefarius Software Solutions")))
                {
                ...
                foreach (var entry in storeEntries.Where(dse => dse.DriverSignerName.Contains("libwdi autogenerated")
                                                           && (dse.DriverPkgProvider.Equals("libusbK") || dse.DriverPkgProvider.Equals("libusb.info"))))
                {
                    Log.InfoFormat("Removing package from driver store: {0} by {1}", entry.DriverPublishedName, entry.DriverPkgProvider);
                    DrvStore.DeletePackage(entry, true);
                }
